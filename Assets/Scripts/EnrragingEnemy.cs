...
public class EnrragingEnemy : EnemyObject
{
    private float speed = 5;
    private float enrragedSpeed = 10;
    ...
    {
        if (currentHealth < maxHealth / 2) // si ses pv sont inferieurs à 50%; il va plus vite et change d'animation, c'est sa seule différence avec first ennemy
        {
            speed = enrragedSpeed;
            animator.SetBool("isenrraged", true);
        }
